...
contract MyRepayContract is IUniswapV3FlashCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function swapWETHForToken(address token, uint256 amountIn) external returns(uint256 amountOut) {
